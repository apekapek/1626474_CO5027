<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Site2.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Assignment.admin.index1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Maincontain" runat="server">
    ...
    <p> &nbsp;</p>
    <p> 
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="ProductID" DataSourceID="SqlDataSource" ForeColor="Black" GridLines="None">
            <Columns>
