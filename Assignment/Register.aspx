...
<asp:Content ID="Content3" ContentPlaceHolderID="Content" runat="server">
    <form id="form1" runat="server">
        ...
        <asp:RequiredFieldValidator ID="reqUsername" runat="server" ControlToValidate="txtRegUser" ErrorMessage="please enter the username" Display="None"></asp:RequiredFieldValidator>
        <br />
        <br />
